...
export const getCompilerOptionsFromParams = (
  ...
  params.forEach((val, key) => {
    ...
    if (playgroundDefaults[key]) {
      ...
      // @ts-ignore: Typescript isn't happy
...
export const createURLQueryWithCompilerOptions = (location: Location | URL, _sandbox: any, paramOverrides?: any): string => {
  const sandbox = _sandbox as Sandbox
  const initialOptions = new URLSearchParams(location.search)
