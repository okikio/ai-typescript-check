import { Typescript, CompilerOptions } from "./types.ts"
...
export const extractTwoSlashCompilerOptions = (ts: typeof Typescript) => {
...
export const twoslashCompletions = (ts: typeof Typescript) => (
  value: string,
  position: number,
  _token: any
) => {
